ChatGPT-5o.
Prompt: ‘‘Is <br> inside <p> legal?’’
Yes, apparently, and it is used primarily for things like poetry too.

-- Sherif.

ChatGPT-5o.
Prompt: ‘‘Why isn’t this code wrapping around. I need the 30% section to wrap around to the other side. Is that possible in pure HTML?’’
The first answer was a strong no, but it contradicts the spec sheet. I pressed it further and gave it a screenshot of that part of the spec sheet.
It said it was still correct, but the only way which is common in this type of course is to use <table>. I take the ‘‘common in this course’’ with a grain of salt, but if it works, it works.
